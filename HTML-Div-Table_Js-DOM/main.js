...
var link = document.createTextNode("Home Div");
...
var link = document.createTextNode("Home Div JS");
js.appendChild(link); 
js.title = "JS";
js.href = "designWithJs.php"; 
menuBar.appendChild(js);
console.log(js.className);

let form = document.createElement('a');
form.classList.add('btn');
var link = document.createTextNode("Form Table");
form.appendChild(link); 
form.title = "Form";
form.href = "form.php"; 
menuBar.appendChild(form);
console.log(form.className);

let formJs = document.createElement('a');
formJs.classList.add('btn');
var link = document.createTextNode("Form Table JS");
formJs.appendChild(link); 
formJs.title = "formJs";
formJs.href = "formWithJS.php"; 
menuBar.appendChild(formJs);
console.log(formJs.className);

let blog = document.createElement('a');
blog.classList.add('btn');
var link = document.createTextNode("File Include");
blog.appendChild(link); 
blog.title = "File Include";
blog.href = "mainIndex.php"; 
...
p.innerHTML = "CopyRight &copy; SwapnoLoke 2020";
